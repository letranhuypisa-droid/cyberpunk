...
| `js/app.js` | Router màn hình, lobby, squad (3 slot, lưu đội), sector, **dẹp loạn** (`renderRiot`), gacha một bể, archive (tab Kỹ năng / Passive / Hồ sơ), config, COMMS |
...
| `scratch/sprite_size.py` | Đo cỡ người thật trên sprite (hộp bao phần không trong suốt) theo % hộp 682 — chốt `RECRUIT_BODY_H` để đơn vị chiêu mộ cao bằng nhân vật |
