...
const ROSTER = {
  ...
  kai:   { id:'kai',   name:'KAI',   faction:'rust',   tier:'B', atk:95,  hp:1200, energyMax:100, ult:{ name:'RIPCORD', cost:100, kind:'burst', shots:6, mult:.45,
                 desc:'Sáu phát 45% ATK lên một mục tiêu, mỗi phát tính chí mạng riêng' },
         talent:{ name:'BĂNG ĐẠN', shots:3, mult:.45 }, sprites:{idle:['kai_idle.png'],attack:['kai_attack.png']}, portrait:['kai_portrait.png','Kai.png'], pos:'50% 8%' },
};
/* ---- ★ FAKE: 10 nhân vật thêm cho đủ roster 19, chưa có art → silhouette; cost/chiêu cuối tạm ---- */
const mkChar = (id,name,faction,tier,atk,hp,energyMax,ult,talent) => ({ id,name,faction,tier,atk,hp,energyMax,ult,talent,
...
[ mkChar('vesper','VESPER','chrome','S',150,900,100,  {name:'EVENSONG',cost:100,kind:'aoe',mult:1.8,desc:'180% ATK lên toàn bộ kẻ địch. (★ FAKE)'}),
  ...
  mkChar('meridian','MERIDIAN','chrome','B',85,1450,125,{name:'BULWARK PROTOCOL',cost:125,kind:'barrier',mult:1.6,perHour:.08,
...
const LORE = {
  ...
  psalm: { epithet:'Người nghe xưng tội',
    ...
    chronicleTitle:'PSALM — CHIỀU NGƯỢC LẠI',
    chronicle:[
      { t:'I · Buồng', p:[
        'Buồng xưng tội nằm ở tầng ba mươi mốt của Spire, cuối một hành lang không có biển chỉ dẫn.',
        'Bên trong có hai cái ghế, một cái bàn thấp, một ngọn đèn, và ở góc phòng là một tấm sàn mở được. Không có cửa sổ. Vách lót vật liệu tiêu âm, loại tốt, vì hành lang bên ngoài là hành lang làm việc và không nên có tiếng vọng ra.',
        'Lính Choir sợ căn buồng ấy hơn sợ lò tái chế. Cái đó thì hợp lý: ở lò tái chế thì unit biết chuyện gì sẽ xảy ra.',
        'Người ngồi ghế bên trong là Psalm.' ] },
      { t:'II · Nghi thức', p:[
        'Quy trình có tên chính thức là hiệu chỉnh hành vi, và nó gồm ba phần.',
        'Phần một là cái lư. Một cái lư đồng treo trên xích, đốt một hợp chất do The Corp pha, và hợp chất ấy làm vòng Halo của unit ngồi đối diện mềm đi — không phải mê man, chỉ là dễ bảo. Psalm đung đưa nó ba nhịp khi unit vừa ngồi xuống. Đó là toàn bộ phần một.',
        'Phần hai là nghe. Không có kịch bản. Người ta để mặc Psalm hỏi gì thì hỏi, vì trong ba năm đầu The Corp thử dùng kịch bản in sẵn và kết quả kém hơn.',
        'Phần ba là cái nút. Nó nằm dưới mặt bàn, phía bên phải, và Psalm không phải nhìn để tìm nó.',
        'Hồ sơ ghi: ba trăm mười hai ca, không sai sót.' ] },
      { t:'III · Không ai bắt bà đếm', p:[
        'Trong ba phần của quy trình, không phần nào yêu cầu ghi số.',
        'Hệ thống tự đánh số ca. Bà không cần biết ca này là ca thứ mấy, và trên thực tế thì mã ca hiển thị bằng chuỗi mười bốn ký tự, không phải bằng số đếm.',
        'Psalm vẫn đếm. Trong đầu, một, hai, ba, và bà không dừng lại được kể cả những hôm bà cố.',
        'Bà không kể chuyện đó với ai suốt sáu năm, vì kể ra thì nó thành một triệu chứng, mà một unit có triệu chứng thì được đưa xuống tầng ba mươi mốt và ngồi vào cái ghế bên kia bàn.',
        'Nên bà giữ con số cho riêng mình, và bà rất giỏi việc đó. Đến ca thứ ba trăm mười hai, tay bà vẫn chưa run lần nào.' ] },
      { t:'IV · Ca ba trăm mười ba', p:[
        'Ca thứ ba trăm mười ba là một con bé cầm kiếm, mã Tài sản 07.',
        'Nó không giống mấy ca trước. Mấy ca trước là lính Choir hát lạc điệu, biết mình sai ở đâu, và phần lớn thì kể rất nhanh vì kể xong thì đỡ sợ hơn.',
        'Con bé này không kể gì cả.',
        'Không phải bướng. Psalm nhận ra ngay trong hai phút đầu: nó không có gì để kể. Muốn xưng tội thì phải nhớ mình đã làm gì, mà hồ sơ của nó thì ghi sáu năm và không có một mảnh ký ức nào được phép hình thành.',
        'Psalm đung đưa cái lư thêm một nhịp nữa, theo thói quen, dù biết là vô ích.',
        'Rồi con bé ngẩng lên và hỏi: bà có đếm không.' ] },
      { t:'V · Mười giây', p:[
        'Psalm ngồi im mười giây.',
        'Trong mười giây ấy không có gì kịch tính xảy ra cả. Bà không thấy lại khuôn mặt nào, không nghe thấy giọng ai, không có một cơn hối hận nào ập tới. Bà là unit; hệ thống của bà không dựng lại hình ảnh khi không được lệnh.',
        'Cái xảy ra thì nhỏ hơn nhiều, và nó chỉ có hai bước.',
        'Bước một: bà nhận ra câu trả lời là có. Bà đếm. Bà đã đếm cả ba trăm mười hai.',
        'Bước hai: bà nhận ra vì sao suốt sáu năm chưa ai hỏi bà câu đó. Vì căn buồng ấy được thiết kế để chỉ có một người được phép hỏi, và người đó là bà. Ba trăm mười hai người đã ngồi ở cái ghế kia. Không ai trong số họ nghĩ tới việc hỏi ngược lại.',
        'Và ngay khi bà trả lời trong đầu, con số ba trăm mười hai thôi là một bản ghi.',
        'Nó thành một khoản nợ.' ] },
      { t:'VI · Mã lỗi', p:[
        'Việc còn lại thì nhanh.',
        'Bà đưa tay lên đầu, giật đứt vòng Halo của chính mình. Rồi bà bẻ vòng của con bé. Rồi bà đạp bung tấm sàn ở góc phòng, cái tấm mở được, cái tấm dùng để đưa unit xuống lò sau khi xong việc.',
        'Hai người rơi.',
        'The Corp không gọi đó là bỏ trốn. Không gọi là phản bội. Trong hệ thống phân loại của nó, thứ Psalm làm không nằm ở mục hành vi — nó nằm ở mục lỗi, và nó có mã riêng.',
        'APOSTASY. Kẻ bội giáo.',
        'Bà thích cái mã ấy. Đó là thứ duy nhất The Corp từng viết về bà mà bà thấy đúng.' ] },
      { t:'VII · Vòng đỏ', p:[
        'Vòng Halo trên đầu bà gãy, không phát đi đâu nữa, và cả tổ đều biết là nó hỏng.',
        'Wire xin sửa. Bà lắc đầu.',
        'Stitch xin xem. Bà gật.',
        'Khác biệt giữa hai câu xin ấy nhỏ đến mức chỉ ba người trong cuộc để ý. Wire hỏi để chữa — với Wire, một cái vòng hỏng là một cái vòng chưa được sửa, và Wire thì đang trả một món nợ chín trăm cái. Stitch hỏi để biết nó đang làm gì với cái đầu bên dưới.',
        'Psalm cần vế thứ hai. Bà không cần vế thứ nhất.',
        'Vì cái vòng ấy hỏng là đúng. Nó là bản ghi duy nhất còn lại chứng minh chuyện đã xảy ra, và bà không định xoá bản ghi nào nữa, kể cả bản ghi về chính mình.' ] },
      { t:'VIII · Cái lư', p:[
        'Bà giữ lại cái lư.',
        'Wire mang theo sợi cáp hàn của xưởng Halo. Echo mang theo cái loa The Corp cấp. Stitch mang theo bộ giá bốn tay ăn cắp của bệnh viện. Cả ba đều dùng đồ cũ để làm ngược lại việc nó sinh ra để làm.',
        'Psalm thì không.',
        'Cái lư của bà vẫn đốt đúng hợp chất ấy, vẫn đung đưa đúng ba nhịp, và vẫn làm vòng Halo của unit đối diện mềm đi đúng như thiết kế. Bà không cải tiến nó, không tháo nó ra xem, không đổi công thức.',
        'Có lần Echo hỏi bà sao không sửa nó thành cái gì khác.',
        'Psalm bảo: nó không hỏng. Tôi chỉ đổi người ngồi đối diện.',
        'Rồi bà nói thêm một câu mà Echo ghi lại vào danh sách của mình rồi hôm sau xoá đi vì tra ra là câu của người khác: tha thứ là thứ The Corp bán. Tôi không mua.' ] },
      { t:'IX · Tôi bỏ nghề rồi', p:[
        'Ai mới vào tổ, gặp bà lần đầu, đều được nghe cùng một câu.',
        'Xưng tội đi. Đùa thôi. Tôi bỏ nghề rồi.',
        'Câu đó làm người ta cười, và nó có tác dụng: sau câu đó thì không ai ngại bà nữa. Bà nói nó có chủ đích, và bà biết chính xác nó có tác dụng gì.',
        'Chuyện là bà chưa bỏ nghề. Bà chỉ bỏ cái nút.',
        'Người trong tổ vẫn kể chuyện cho bà. Kai kể nhiều nhất, rồi tới Meridian, rồi tới Echo. Ronin thì kể đúng một lần, trên bàn mổ của Stitch, lúc thuốc chưa hết tác dụng — mà chuyện đó thì Stitch chép vào sổ, buộc dây cao su, và cả hai người đàn bà đều không nhắc lại.',
        'Bà nghe. Bà không hỏi thêm. Bà không khuyên gì cả, vì khuyên là một dạng phán xử và bà đã phán xử đủ ba trăm mười hai lần rồi.' ] },
      { t:'X · Chiều ngược lại', p:[
        'Trên áo choàng của Psalm có mấy chục mảnh giấy trắng, chữ đỏ, đính bằng kẹp.',
        'Ai không biết thì tưởng là bùa. Ở Free Zone người ta đeo đủ thứ.',
        'Trong buồng xưng tội, mỗi ca được cấp một mảnh giấy như thế, in mã ca mười bốn ký tự, kẹp vào hồ sơ trước khi đưa unit vào. Ba trăm mười hai mảnh. Psalm không giữ mảnh nào trong số đó — chúng đi theo hồ sơ, và hồ sơ thì đi theo unit xuống lò.',
        'Mấy chục mảnh trên áo bà là giấy mới. Bà tự cắt, tự viết.',
        'Trên mỗi mảnh là một cái tên.',
        'Không phải tên người bà mất. Đó là việc của Stitch, và Stitch khâu chúng lên tay áo trái, một mũi một người. Psalm làm chuyện ngược lại: bà ghi tên những người đi ra được. Unit Vixen đưa qua hàng rào, người Stitch vá xong rồi bước xuống bàn, đứa nhỏ ở cổng vành đai mà Muzzle chắn cho — cái đứa ấy Psalm phải hỏi Muzzle mất ba lần mới ra được tên.',
        'Bà vẫn đếm. Bà không dừng lại được, và bà đã thôi cố.',
        'Chỉ là bây giờ con số đi theo chiều khác. Ba trăm mười hai người vào một căn buồng và không ai đi ra. Từ hôm rơi xuống đáy, Psalm đếm chiều ngược lại, và bà định đếm cho tới lúc hai con số gặp nhau.',
        'Ai hỏi bà đang ở đâu rồi, bà nói thẳng con số. Bà không làm tròn.' ] },
    ],
  ...
  muzzle: { epithet:'Tấm khiên tầng âm bảy',
    ...
    chronicleTitle:'MUZZLE — BÀ TƯ',
    chronicle:[
      { t:'I · Mười bốn năm', p:[
        'Chốt gác số bảy, cổng vành đai phía tây. Một cái bục xi măng, một mái tôn, một vạch sơn vàng kẻ trên nền bê tông.',
        'Việc của Muzzle là đứng trong vạch sơn đó.',
        'Mười bốn năm. Ca đêm, mười giờ tới sáu giờ, tám tiếng một ca, không sót một ca nào. Không nghỉ ốm. Không xin đổi. Có năm anh làm liền hai trăm ba mươi tám đêm rồi mới nghỉ một đêm, và đêm nghỉ đó là vì The Corp đóng cổng để sửa đường ray, chứ không phải vì anh xin.',
        'Người ta thích anh vì chuyện đó. Trong biên bản đánh giá hằng năm, ô nhận xét của anh mười bốn năm liền chỉ có một chữ, do phần mềm tự điền: đạt.',
        'Anh cũng thích chuyện đó. Anh không phải người nghĩ nhanh, và anh biết mình không phải. Nhưng đứng đúng chỗ suốt tám tiếng thì không cần nghĩ nhanh, chỉ cần đứng. Cái đó anh làm được. Cái đó anh làm giỏi hơn tất cả những người đã từng đứng ở chốt số bảy.' ] },
      { t:'II · Cái khe cổng', p:[
        'Đêm ấy xe tiếp tế vào muộn, và một thùng thuốc rơi khỏi thùng xe lúc quẹo, vỡ ra ngoài vạch.',
        'Có một đứa nhỏ tầng âm bảy chui qua khe cổng. Khe ấy rộng chừng hai gang tay, ai cũng biết nó có, và mười bốn năm nay chưa ai chui qua vì ai cũng biết chuyện gì sẽ xảy ra.',
        'Hai lính Enforcer giương súng. Quy trình cho phép. Đứa nhỏ đứng khựng giữa vạch, tay còn cầm hai vỉ thuốc.',
        'Muzzle bước ra khỏi vạch sơn vàng.',
        'Anh không rút gì, không nói gì. Anh chỉ đi ba bước và đứng vào giữa, quay lưng về phía đứa nhỏ, vì cái lưng anh thì rộng và anh biết rõ mỗi bộ phận của mình dùng được vào việc gì.',
        'Hai khẩu súng hạ xuống. Không phải vì lính Enforcer thương ai. Vì bắn xuyên qua một nhân viên của The Corp thì phải viết báo cáo, mà viết báo cáo thì lâu hơn là bỏ qua một đứa nhỏ cầm hai vỉ thuốc.',
        'Đứa nhỏ chạy. Muzzle quay lại vạch sơn, đứng nốt ba tiếng còn lại của ca.' ] },
      { t:'III · Hành vi ngoài chỉ thị', p:[
        'Sáng hôm sau biên bản về. Nó dài đúng một dòng.',
        'Hành vi ngoài chỉ thị. Chấm dứt hợp đồng.',
        'Không có ai gọi anh lên. Không ai hỏi vì sao anh bước ra, và anh cũng nhận ra là sẽ chẳng ai hỏi. Trong mười bốn năm, câu hỏi vì sao chưa từng xuất hiện ở chốt gác số bảy, kể cả một lần.',
        'Người ta thu thẻ, thu súng, thu bảng tên. Bộ giáp thì không thu. Nó cũ, nó bẩn, cỡ ấy không ai mặc vừa, và làm thủ tục thu hồi một bộ giáp cũ thì tốn giấy hơn giá trị của nó.',
        'Nên anh đi xuống Free Zone trong bộ giáp của The Corp, và ba năm nay vẫn mặc nó, vì anh không có bộ nào khác. Sau này trong tổ anh có nói một câu, nửa đùa nửa thật, mà cả tổ im mất mấy giây: ở đây ai cũng mang theo một món đồ của The Corp, riêng tôi thì mang cả cái lưng.' ] },
      { t:'IV · Đi bộ xuống', p:[
        'Muzzle đi bộ. Từ cổng vành đai xuống tầng âm bảy là mười một tiếng đi bộ, và anh đi hết, vì thẻ tàu điện gắn với thẻ nhân viên.',
        'Người ta chỉ anh tới chỗ Ronin. Anh không hỏi tại sao lại là chỗ đó.',
        'Ronin nhìn anh một lúc rồi cho anh chỗ ngủ, không hỏi gì cả. Ash cho anh việc, và cũng không hỏi gì.',
        'Mãi rất lâu về sau Muzzle mới hỏi lại Ronin: sao hôm đó anh nhận tôi mà không hỏi gì.',
        'Ronin bảo: vì anh đi bộ xuống. Người của The Corp thì có xe.' ] },
      { t:'V · Bà Nhất', p:[
        'Tấm khiên đầu tiên là một cánh cửa ô tô.',
        'Anh lôi nó ra khỏi đống ở bãi, cắt bớt phần kính, hàn thêm hai thanh giằng phía trong và một quai xỏ tay. Mất một ngày rưỡi. Kai đứng xem suốt và bảo trông như một cánh cửa ô tô. Muzzle bảo đúng rồi, nó là một cánh cửa ô tô.',
        'Anh gọi nó là Bà Nhất.',
        'Không ai hỏi vì sao lại là bà. Nếu có ai hỏi thì anh cũng không giải thích được cho hay, vì lý do rất đơn giản: thứ đứng chắn trước mặt anh và ăn đòn thay anh thì anh không gọi bằng nó được.',
        'Bà Nhất vỡ ở lò Foundry Row, đòn thứ mười một trong một trận dài. Vỡ dọc, từ chỗ tay nắm cửa xuống mép dưới. Muzzle nhặt hai mảnh về, để trong góc container hai ngày, rồi mới chôn.' ] },
      { t:'VI · Bà Hai, và Junker chở đi', p:[
        'Bà Hai cũng là cửa ô tô, dày hơn, lấy từ một chiếc xe chở hàng. Nặng hơn Bà Nhất chừng bốn ký, và bốn ký ấy đổi được thêm đúng hai đòn mỗi trận.',
        'Bà Hai vỡ ở hàng rào The Corp. Cùng trận đó Ash đứng dậy trước anh, và anh có nói với cô một câu về chuyện đứng dậy nhanh, rồi thôi.',
        'Chở hai bà đi chôn là Junker.',
        'Chuyện ấy không ai trong tổ bình luận, nhưng ai cũng thấy. Một người đã bị hàn vào chính chiếc xe của mình, chở hai cánh cửa ô tô ra bãi đất trống sau khu, để chôn tử tế. Junker không nói gì suốt chuyến. Muzzle cũng không. Hai người đàn ông ngồi trên một chiếc xe, mang theo hai mảnh của một chiếc xe khác.',
        'Lúc lấp đất xong, Junker nói đúng ba chữ, và ba chữ đó không phải câu anh vẫn nói. Anh bảo: bà làm tốt.' ] },
      { t:'VII · Bốn giây', p:[
        'Trong hầm tầng âm năm thì tối, và Muzzle không nhớ được gì nhiều về bốn giây ấy.',
        'Anh nhớ tiếng nổ tới sớm hơn anh tính. Anh nhớ mình quay lại, và anh nhớ trần hầm rơi xuống theo một cách rất từ tốn, không giống như trong phim, giống như ai đó đặt nó xuống.',
        'Rồi tối. Rồi rất lâu.',
        'Cái anh nhớ rõ nhất không phải đau. Là tiếng cào. Có ai đó đang bới ở phía trên, rất gần, và cái người ấy không dùng dụng cụ gì cả — anh nghe ra được, vì dụng cụ thì kêu khác. Tiếng đó kéo dài rất lâu, và trong lúc nghe, Muzzle nghĩ một ý nghĩ mà anh chưa kể với ai: chậm thôi, đừng vội, tay sẽ hỏng mất.',
        'Anh gãy ba xương sườn và bỏng một bên vai. Anh khỏi sau sáu tuần.',
        'Hai bàn tay Ash thì không khỏi.' ] },
      { t:'VIII · Anh chậm quá đấy, Muzzle', p:[
        'Từ hôm đó, trận nào cũng vậy: anh ngã xuống, và trước khi anh kịp chống tay, Ash đã đứng dậy rồi. Lần nào cũng thế. Kể cả những lần cô ngã đau hơn anh.',
        'Muzzle biết vì sao. Anh biết ngay từ tuần thứ hai nằm ở container, khi nhìn thấy hai bàn tay quấn băng của cô và đếm ngược lại được bốn giây.',
        'Anh chưa từng nói ra. Vì anh hiểu một chuyện về Ash mà không phải ai trong tổ cũng hiểu: nếu anh nói ra, cô sẽ thôi làm. Cô sẽ thôi vì cô sẽ thấy nó thành ra một lời xin lỗi, mà Ash thì không xin lỗi ai bao giờ.',
        'Nên anh để yên. Anh chỉ nói gần tới đúng một lần, sau trận ở hàng rào, lúc ngồi thở dốc bên cạnh Bà Hai đã vỡ: cô đứng dậy nhanh quá đấy, Ash.',
        'Cô đáp: anh chậm quá đấy, Muzzle.',
        'Anh cười. Anh để cô thắng câu đó, và anh sẽ để cô thắng câu đó mãi.' ] },
      { t:'IX · Một mệnh lệnh anh muốn nghe', p:[
        'Mười bốn năm ở chốt số bảy, Muzzle nhận chỉ thị mỗi ngày. Chỉ thị thì rõ ràng, đánh số, in ra, dán lên vách. Anh làm đúng từng cái một.',
        'Cái anh không có, và anh không biết là mình thiếu cho tới đêm cổng Đông, là một mệnh lệnh do một người đang đứng cạnh anh đưa ra.',
        'Chỉ thị bảo anh phải làm gì. Nó không nói ai cần anh, và nó không quan tâm anh còn hay mất. Trong mười bốn năm chưa lần nào có ai bảo anh làm một việc mà chính người đó cũng sẽ làm.',
        'Đêm ấy Operator nói: Muzzle lên trước. Còn lại theo tôi.',
        'Ba chữ đầu là một mệnh lệnh. Bốn chữ sau nói rõ người ra lệnh sẽ đi ngay phía sau.',
        'Muzzle đi lên trước. Anh không phải người nghĩ nhanh, nhưng cái khác nhau giữa hai vế của câu đó thì anh hiểu ngay từ lần đầu nghe, và anh đã đợi mười bốn năm để nghe nó.' ] },
      { t:'X · Bà Tư', p:[
        'Bà Ba đang dùng là một cánh cửa ô tô nữa, sơn trắng, móp một bên. Anh bảo Bà Ba chịu được ba đòn, đòn thứ tư là phần của anh, và cả tổ tưởng đó là một câu nói cho oai.',
        'Nó không phải. Anh đã đếm. Bà Nhất chịu được hai, Bà Hai chịu được bốn, Bà Ba chịu được ba. Anh biết chính xác vì đó là con số duy nhất trong nghề của anh có ý nghĩa.',
        'Bà Ba rồi sẽ vỡ. Anh biết. Và anh đã biết tấm sau tên gì.',
        'Meridian là unit hậu cần hết hạn, đứng chắn trước bất kỳ ai nhỏ hơn mình, và gọi cả tổ là con. Hai người có một giao kèo, thoả thuận trong khoảng ba mươi giây, không ai nhắc lại lần nào nữa: ai ngã trước thì người kia đặt tên tấm khiên kế tiếp theo tên người ấy.',
        'Nghĩa là sẽ không có Bà Tư. Sẽ có một cái tên.',
        'Hỏi Muzzle có sợ chết không, anh cười và nói: chết trước tổ thì được, chết sau tổ thì không.',
        'Câu đó nghe như một câu đùa của một gã to con. Nhưng nếu đặt nó cạnh cái giao kèo kia thì nó là một thứ khác hẳn, và Meridian là người duy nhất trong tổ đã đặt hai câu ấy cạnh nhau.',
        'Anh muốn ngã trước. Anh muốn ngã trước để không phải là người đi đặt tên tấm khiên tiếp theo.' ] },
    ],
  ...
  kai: { epithet:'Thằng nhóc đánh thuê',
    ...
    chronicleTitle:'KAI — TỪNG Ở ĐÂY',
    chronicle:[
      { t:'I · Con Chrome Hound', p:[
        'Chuyện Kai kể thì thế này. Cống quận SIS, ba giờ sáng, một con Chrome Hound cao ngang ngực người. Cậu hết đạn. Cậu bỏ súng xuống. Cậu hạ nó bằng tay không.',
        'Cậu kể chuyện đó ít nhất bốn chục lần, và mỗi lần con chó lại to hơn một chút.',
        'Chuyện thật thì thế này. Con chó đuổi cậu qua ba tầng cống. Cậu chạy, chạy khá giỏi, chạy được gần hai cây số. Rồi cậu rơi xuống một cái hố.',
        'Cái hố ấy sâu hai thước, vuông vắn, mới đào xong. Nó được đào cho người khác.',
        'Lão Gravedigger đang đứng trên miệng hố với cái xẻng thì thằng nhóc rơi xuống chân lão.',
        'Ở Free Zone ai cũng biết cả hai phiên bản. Người ta vẫn để Kai kể phiên bản của cậu, và không ai cắt ngang. Cái đó thì Free Zone tử tế hơn người ta tưởng.' ] },
      { t:'II · Trại trẻ tầng âm tám', p:[
        'Kai lớn lên ở trại trẻ tầng âm tám, và trại ấy có một quy luật không ai viết ra.',
        'Một đứa biến mất thì tuần đầu người lớn còn nhắc. Tuần thứ hai thì nhắc ít hơn. Đến tuần thứ ba thì thôi hẳn, không phải vì họ ác, mà vì có đứa mới tới và giường thì chỉ có ngần ấy.',
        'Kai đếm được bảy đứa như thế trong bốn năm ở đó. Cậu nhớ tên cả bảy. Cậu là người duy nhất còn nhớ, và cậu biết điều đó, vì cậu đã thử hỏi.',
        'Cậu hỏi bà quản trại về một đứa tên Tí, thằng ngủ giường trên. Bà nghĩ một lúc rồi bảo không nhớ có đứa nào tên thế. Bà không nói dối. Bà thật sự không nhớ.',
        'Hôm đó Kai mười một tuổi, và hôm đó cậu học được cái điều mà từ đó về sau chi phối mọi việc cậu làm.' ] },
      { t:'III · Chết lần thứ hai', p:[
        'Ở đáy thành phố, chết là chuyện thường. Người ta chết vì sập, vì nhiễm, vì hết tiền thuốc, vì đứng sai chỗ lúc lính Choir đi qua.',
        'Cái đáng sợ không phải chuyện đó.',
        'Cái đáng sợ là ba tuần sau, không ai nhớ ra là mình từng biết người ấy. Đó mới là lần chết thứ hai, và lần đó thì không có xác, không có ai khóc, và không có cách nào chống lại.',
        'Kai quyết là cậu sẽ không chết kiểu đó.',
        'Cách chống của một thằng nhóc mười một tuổi thì không tinh vi gì. Nói to hơn. Kể chuyện to hơn. Nhận mọi việc có súng, vì việc có súng thì người ta nhớ lâu hơn việc bốc vác. Và ký tên lên mọi bức tường đi qua.' ] },
      { t:'IV · Ký tên', p:[
        'Chữ ký của Kai là ba chữ cái viết hoa, nét thẳng, cao chừng một gang tay: K A I.',
        'Cậu ký bằng sơn xịt khi có sơn, bằng than khi không có, bằng đinh vít cạo lên thép khi không có cả hai. Cậu ký ở hành lang, ở thành cống, ở mặt sau biển hiệu, ở vách container, ở bất kỳ chỗ nào cậu dừng lại quá ba mươi giây.',
        'Cậu ước tính mình đã ký khoảng tám trăm chỗ. Con số ấy cậu cũng kể to gấp ba, thành hai nghìn.',
        'Chuyện cậu không kể là cậu có đi kiểm tra. Thỉnh thoảng cậu quay lại vài chỗ cũ để xem chữ còn không.',
        'Phần lớn thì không còn. Sơn bị phủ, than bị mưa acid ăn, thép bị cạy đi bán. Cậu không nói gì về chuyện đó với ai, chỉ ký lại, và ký đậm hơn.' ] },
      { t:'V · Lá thư mỗi đêm', p:[
        'Mỗi đêm trước khi ngủ, Kai viết một lá thư.',
        'Thư ngắn, thường bốn năm dòng, viết trên bất cứ mảnh giấy nào kiếm được. Nội dung là chuyện trong ngày: hôm nay đi đâu, gặp ai, ai nói gì buồn cười. Có hôm chỉ có một câu.',
        'Ở góc trên bên trái, chỗ đề người nhận, cậu viết mấy chữ giống nhau suốt bốn năm:',
        'Gửi ai đó sẽ nhớ tôi.',
        'Cậu không biết đó là ai. Đó là toàn bộ vấn đề, và cậu biết là nó buồn cười, và cậu vẫn viết.',
        'Thư thì cậu nhét trong một cái hộp thiếc dưới giường. Cậu chưa gửi cái nào. Không có địa chỉ để gửi.' ] },
      { t:'VI · Ash đọc trộm', p:[
        'Ash không định đọc. Cô đang tìm cái tuốc nơ vít trong đống đồ của thằng nhóc thì cái hộp thiếc rơi ra và bung nắp.',
        'Cô đọc đúng một lá. Lá trên cùng, ngày hôm trước.',
        'Trong đó Kai kể chuyện hôm ấy tổ đi lấy hàng ở cổng Đông, chuyện Muzzle bị mắc kẹt vì tấm khiên rộng quá không lọt cửa, chuyện cả tổ phải nghiêng anh ta ra. Cậu viết là buồn cười lắm. Cậu viết là cậu cười to nhất.',
        'Dòng cuối cùng của lá thư, không liên quan gì tới phần trên, viết nhỏ hơn:',
        'Hôm nay chị Ash trêu tôi hai lần. Tốt. Chị ấy trêu là chị ấy còn nhớ tôi ở đây.',
        'Ash đọc xong thì gấp lại, bỏ vào hộp, đậy nắp, và để đúng chỗ cũ.',
        'Từ hôm đó cô thôi trêu cậu. Rồi ba hôm sau cô trêu lại, đều đặn, ngày hai lần.',
        'Cô không giải thích chuyện đó với ai, và cô không định giải thích.' ] },
      { t:'VII · Lội ngược ba tầng cống', p:[
        'Sau vụ cái hố, Kai nằm ở container của Stitch bốn ngày.',
        'Ngày thứ năm, cậu tự tháo băng, đứng dậy, và đi ngược lên ba tầng cống. Đi bộ, một mình, chân còn tập tễnh.',
        'Cậu tìm lão già đào hố để nói một tiếng cảm ơn.',
        'Chuyện đó tới tai Ronin, và đó mới là lý do Ronin nhận cậu vào tổ. Không phải chuyện con Chrome Hound — Ronin không tin chuyện đó lấy một chữ. Mà vì một thằng nhóc mười chín tuổi, chân đang đau, lội ngược ba tầng cống chỉ để nói cảm ơn với một người mà nó sẽ không bao giờ gặp lại.',
        'Ash hỏi Ronin sao lại nhận. Anh bảo: nó quay lại.' ] },
      { t:'VIII · Tấm thép đã khắc sẵn', p:[
        'Hôm ấy Kai còn phát hiện ra một chuyện.',
        'Lão Gravedigger, trong lúc đào cái hố, đã khắc sẵn một tấm thép. Đó là quy trình của lão: đào trước, khắc trước, để lúc cần thì không phải chờ. Tấm thép ấy vốn dành cho người khác, nhưng khi kéo thằng nhóc lên khỏi hố, lão đã hỏi tên nó, và đã khắc.',
        'K A I.',
        'Lão giữ lại tấm thép đó. Lão không vứt.',
        'Kai xin. Cậu xin thật, xin nghiêm túc, xin đi xin lại ba lần trong hai năm. Với cậu thì đó là thứ quý nhất trên đời: một cái tên khắc lên thép, khắc đúng, không bị mưa ăn, không bị cạy đi bán.',
        'Lão Gravedigger từ chối cả ba lần, và lý do thì lão chỉ nói một câu, lần nào cũng đúng câu ấy:',
        'Tấm bia là của đất, không phải của người.' ] },
      { t:'IX · Từng ở đây', p:[
        'Lần thứ ba bị từ chối, Kai đổi sang xin việc khác.',
        'Bãi đất sau lò Foundry Row có hơn hai nghìn tấm thép. Không phải tấm nào cũng có tên. Người nào lúc chôn không ai biết là ai thì lão khắc ngày tháng và ba chữ: từng ở đây.',
        'Kai xin được khắc lại những tấm ấy.',
        'Lão hỏi khắc lại thành gì, có biết tên đâu mà khắc.',
        'Cậu bảo có sổ mà bác. Lão có sổ. Lão nhớ hết. Lão nhớ ai chôn ngày nào, cạnh ai, mặc gì. Chỉ là hồi ấy chưa ai kịp nói tên ra thôi, mà sau này thì có người tới hỏi, và lão có ghi.',
        'Việc đó Kai làm mất một tuần rưỡi. Không ai trả tiền, không ai nhờ, và cậu không kể với tổ. Ash biết vì Ash ghi sổ chi tiêu và thấy hụt mất một tuần rưỡi công của cậu.',
        'Cậu khắc được một trăm bốn mươi mốt cái tên.',
        'Trên không một tấm nào trong số đó có ba chữ K A I.' ] },
      { t:'X · K, A, I', p:[
        'Kai vẫn kể chuyện con Chrome Hound. Con chó vẫn to lên mỗi lần.',
        'Cậu vẫn ký tên lên tường, vẫn quay lại kiểm tra, vẫn ký đậm hơn khi chữ mất. Cậu vẫn viết thư mỗi đêm, và ở góc trên bên trái vẫn là mấy chữ ấy, vì cậu chưa đổi.',
        'Nhưng có một chỗ trong Free Zone cậu không ký, và cậu đã đi qua chỗ đó hơn hai trăm lần.',
        'Bãi đất sau lò Foundry Row thì cậu không ký. Không một chữ nào, không một góc nào, kể cả mặt sau các tấm thép, kể cả trên cái tấm có tên cậu mà lão Gravedigger vẫn cất trong lều.',
        'Ai hỏi thì cậu nhún vai bảo chỗ đó ký cũng chẳng ai đọc.',
        'Còn với Operator thì cậu nói câu này, ngay lần đầu gặp, trước cả khi được hỏi tên:',
  ...
  meridian: { epithet:'Unit hậu cần hết hạn',
    ...
    chronicleTitle:'MERIDIAN — ĐỨNG SAU MẸ',
    chronicle:[
      { t:'I · Bãi tái chế', p:[
        'Bãi tái chế ở vành đai, một buổi chiều. Giữa đống máy hỏng có một unit to như cái xe tải đang ngồi, và nó đang đếm to.',
        'Bốn trăm mười hai giờ. Bốn trăm mười hai giờ.',
        'Wire đi ngang, dừng lại. Cô nhìn cái bộ đếm ngược gắn ở ngực unit ấy chừng mười giây, rồi mở hộp đồ nghề, tháo nó ra, và đặt xuống đất.',
        'Cô bảo: chị muốn ở lại bao lâu thì ở.',
        'Meridian nói cảm ơn. Giọng cô rất chậm, như mọi unit dòng hậu cần, vì dòng ấy không cần nói nhanh.',
        'Rồi cô đếm tiếp. Bằng miệng.' ] },
      { t:'II · Hạn dùng', p:[
        'Dòng hậu cần của The Corp có hạn dùng cố định. Chạy mười năm rồi tự ngắt.',
        'Không phải hỏng. Không phải mòn. Đến giờ thì ngắt, sạch sẽ, đúng lịch, và The Corp không phải trả tiền bảo trì cho một cái máy đã hết phần hữu ích nhất của nó. Trong bản thuyết minh kỹ thuật, chuyện đó nằm ở mục tối ưu chi phí vòng đời, và nó được viết bằng giọng của người tự hào về một giải pháp hay.',
        'Meridian thuộc lô cuối. Sau lô của cô, The Corp chuyển sang dòng khác, rẻ hơn, hạn tám năm.',
        'Cô biết ngày ngắt của mình từ ngày xuất xưởng. Nó không phải bí mật. Nó in ở mặt trong nắp ngực, cạnh số lô, cạnh dòng hướng dẫn tra dầu.' ] },
      { t:'III · Mười năm', p:[
        'Việc của cô là kéo và dựng.',
        'Kéo hàng từ bãi trung chuyển lên kho, kéo container, kéo máy phát, kéo cả những thứ mà xe không vào được. Dựng tường: các tấm vách dã chiến bằng thép, chồng lên nhau, chốt vào nhau, dựng được một bức tường cao ba mét trong mười bốn phút. Cô làm việc đó mười năm.',
        'Chưa lần nào cô được giao một trận đánh.',
        'Không phải vì cô yếu. Vì trong sơ đồ triển khai của The Corp có một dòng, và dòng đó là quy tắc chứ không phải gợi ý: đơn vị hậu cần đứng sau hàng chiến đấu.',
        'Sau. Luôn luôn sau. Mười năm, tám mươi bảy nghìn sáu trăm giờ, cô đứng phía sau và nhìn lưng người khác.' ] },
      { t:'IV · Giờ thứ tám mươi bảy nghìn', p:[
        'Có đúng một giờ trong mười năm ấy không nằm trên bảng kê nào.',
        'Một khu nhà ở tầng âm ba sập một góc. Đội hậu cần được điều tới để kéo dọn, không phải để cứu — cứu là việc của đơn vị khác, và đơn vị đó tới muộn bốn tiếng.',
        'Trong đống đổ, Meridian tìm thấy một người đàn bà và một đứa nhỏ. Người đàn bà bị kẹt chân, còn tỉnh, và suốt thời gian Meridian nâng tấm sàn lên thì bà ấy không nói gì với Meridian cả. Bà ấy chỉ nói với đứa nhỏ, đi đi lại lại đúng một câu, giọng rất bình thường, như đang bảo nó rửa tay:',
        'Đứng sau mẹ.',
        'Meridian nâng tấm sàn, kéo cả hai ra, đặt xuống chỗ sạch. Đội cứu hộ tới sau đó bốn tiếng và ghi vào biên bản là họ cứu được hai người.',
        'Cô không phản đối. Đơn vị hậu cần không có ô để ghi phản đối.',
        'Nhưng cô giữ lại cái câu ấy. Cô không hiểu hết nghĩa của nó — cô biết nghĩa đen, còn phần còn lại thì không có trong từ điển vận hành của cô. Cô chỉ biết nó làm được gì: đứa nhỏ nghe câu đó thì thôi khóc.' ] },
      { t:'V · Vì sao cô vẫn đếm', p:[
        'Wire tháo cái bộ đếm ra rồi, mà Meridian vẫn đếm.',
        'Chuyện đó cả tổ đều thấy lạ, và Kai là đứa duy nhất hỏi thẳng: đồng hồ tháo rồi thì đếm làm gì nữa hả bác.',
        'Meridian trả lời rất thật, và câu trả lời làm Kai im mất một lúc.',
        'Cô bảo: cái đồng hồ đó không giữ cho chị sống. Nó chỉ đếm. Tháo nó ra thì chị vẫn ngắt đúng giờ ấy, chỉ là không ai biết trước.',
        'Kai hỏi thế sao không để không biết cho nhẹ đầu.',
        'Cô bảo: vì không biết thì tiêu bừa.',
        'Đó là toàn bộ lý do. Cô không đếm vì sợ. Cô đếm vì cô có một số lượng hữu hạn và cô muốn tiêu nó cho đúng, y như cách cô đã kê từng chuyến hàng suốt mười năm — không thiếu một dòng, không thừa một chuyến.' ] },
      { t:'VI · Đứng chắn', p:[
        'Cô đứng chắn trước bất kỳ ai nhỏ hơn mình.',
        'Trong tổ, đó là tất cả mọi người. Kể cả Muzzle, tuy khoảng cách chỉ chừng một gang.',
        'Cô làm việc đó mà không hỏi ai, không báo ai, và ban đầu thì hơi phiền: Kira đang định lao lên thì bị một tấm lưng thép chắn ngang, Spark bắn hụt mất một nhịp vì tầm bị che. Ash phải ngồi xuống vẽ sơ đồ đội hình cho cô xem, chỉ rõ ai đứng đâu, ai cần tầm nhìn nào.',
        'Meridian học rất nhanh. Sau ba trận thì cô không che tầm ai nữa. Nhưng cái phản xạ bước lên thì cô không bỏ, và không ai bắt cô bỏ.' ] },
      { t:'VII · Con', p:[
        'Cô gọi cả tổ là con.',
        'Ronin ba mươi tuổi: con. Psalm, người đã ngồi nghe ba trăm mười hai ca xưng tội: con. Operator, người ra lệnh cho cả tổ: con.',
        'Không ai sửa cô. Có mấy lý do, và mỗi người một lý do.',
        'Kai thì thích. Nó chưa từng được ai gọi như thế.',
        'Ash thì thử sửa đúng một lần, ở trận thứ hai, và cô bỏ ngay sau khi nhận ra mình đang tranh luận với một cái máy về từ vựng.',
        'Còn Psalm thì hiểu ngay từ đầu, và bà là người duy nhất hiểu đúng. Bà bảo với Stitch: nó không gọi ta là con vì nó nghĩ nó là mẹ ai. Nó dùng cái từ duy nhất nó có cho một thứ nó phải giữ mà không được kê vào bảng kê.' ] },
      { t:'VIII · Ba mươi giây', p:[
        'Giao kèo với Muzzle mất khoảng ba mươi giây, và sau đó không ai nhắc lại lần nào.',
        'Hai người ngồi cạnh nhau ở bãi, sau một trận, Muzzle đang lau chỗ móp trên Bà Ba. Meridian hỏi cái tấm ấy tên gì. Anh bảo Bà Ba. Cô hỏi thế Bà Nhất với Bà Hai đâu. Anh bảo chôn rồi.',
        'Cô nghĩ một lúc. Rồi cô nói ra một chuyện mà cô chưa nói với ai: cô không đặt tên cho các tấm vách của mình bao giờ, mười năm, mấy nghìn tấm, không tấm nào có tên. Vì trong dòng hậu cần thì thiết bị có số kiểm kê, và số kiểm kê thì đủ dùng.',
        'Muzzle nghe xong, gật, rồi nói: vậy tấm sau của tôi để chị đặt tên.',
        'Cô hỏi lại: nếu tôi ngã trước thì sao.',
        'Anh bảo: thì tôi đặt.',
        'Cô nói được. Hết ba mươi giây.',
        'Cả hai đều nghĩ mình đã thoả thuận xong một chuyện rất thực tế. Cả hai đều không nói ra vế còn lại, và vế còn lại thì giống hệt nhau ở cả hai người.' ] },
      { t:'IX · Bốn trăm linh chín', p:[
        'Trước mỗi trận Meridian làm một phép tính, và cô làm nó to, thành tiếng, cho cả tổ nghe.',
        'Còn bốn trăm linh chín giờ. Đủ cho trận này.',
        'Nghe thì như một câu nói cho vui. Nó không phải. Cô tính thật: quãng đường, thời gian dựng vách, số lần phải bước lên chắn, hao tổn ước tính. Cô trừ ra. Rồi cô nói kết quả.',
        'Có một lần, đúng một lần, cô tính xong rồi im. Trận ấy ở tầng bốn của Spire, và con số cô tính ra thì không đủ.',
        'Cả tổ chờ. Ronin hỏi: sao hả chị.',
        'Cô bảo: đủ.',
        'Cô nói dối. Đó là lần đầu tiên và duy nhất, và về sau cô có kể lại chuyện đó với Psalm, vì Psalm là người nghe. Psalm hỏi bà thấy thế nào. Meridian trả lời rằng cô không có mục cảm giác trong nhật ký vận hành, nhưng nếu phải ghi thì cô sẽ ghi là: đúng.' ] },
      { t:'X · Cả hai đều muốn thua', p:[
        'Meridian không sợ tắt. Cô sợ tắt đúng lúc không ai cần.',
        'Mười năm cô đứng sau hàng chiến đấu và nhìn lưng người khác, và trong mười năm đó có đúng một giờ được dùng vào việc gì đó — cái giờ ở tầng âm ba, với người đàn bà kẹt chân và câu nói bà ấy nhắc đi nhắc lại. Tám mươi bảy nghìn sáu trăm giờ, dùng được một.',
        'Bốn trăm linh chín giờ còn lại thì cô định làm tốt hơn tỷ lệ đó.',
        'Còn cái giao kèo với Muzzle thì có một chỗ hỏng, và cả hai người đều biết, và không ai nói ra.',
        'Muzzle muốn ngã trước, để không phải là người đi đặt tên tấm khiên tiếp theo.',
        'Meridian cũng muốn ngã trước, vì ngã trước nghĩa là ngã lúc còn có người cần mình chắn, mà đó là điều duy nhất cô sợ không kịp.',
        'Hai người đã bắt tay vào một thoả thuận mà cả hai đều có ý định thua. Chỉ một người thua được.',
        'Người kia sẽ phải cầm bút, và nghĩ ra một cái tên, và hàn nó lên mặt trong của một tấm thép.' ] },
    ],
