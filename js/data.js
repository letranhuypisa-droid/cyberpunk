...
const ROSTER = {
  ...
  kira:  { id:'kira',  name:'KIRA',  faction:'chrome', tier:'S', atk:145, hp:950,  energyMax:100,
           ...
           // kira_portrait.png = bán thân cắt từ KIRA.png (ô 356,120 → 1034,1320; phóng Lanczos + unsharp nhẹ lên
           // 1084×1920 cho vừa hero ở dpr 2, giữ tỉ lệ 1536:2720 của art thẻ): art gốc toàn thân nên trong
           // thẻ/tile mặt Kira bị nhỏ hơn hẳn phần còn lại của roster.
